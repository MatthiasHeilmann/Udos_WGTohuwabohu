...
class Task(val docId: String, val name: String, val frequency: Int?, val dueDate: Date?, val points: Int?, val roommate: String?, val wg: String?) {
    constructor(vals: DocumentSnapshot): this(
        ...
        vals.getDocumentReference("erlediger")?.id,
