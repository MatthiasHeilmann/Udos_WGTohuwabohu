...
data class Roommate(val docID: String, val email: String, val forename: String, val surname: String, var username: String, val coin_count: Long, val guteNudel_count: Long, val balance: Double, val wg: DocumentReference? ){
